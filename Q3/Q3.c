...
struct SinhVien timTheoTen(struct SinhVien* ds, int slsv) {
	...
	for(i = 0; i < slsv; i++) {
		if(strcmp(ten, ds[i].hoVaTen.ten) == 0) {
			hienThiTTSV(ds[i]);
			sv = ds[i];
//			sv.hoVaTen.ho = ds[i].hoVaTen.ho;
//			sv.hoVaTen.dem = ds[i].hoVaTen.dem;
//			sv.gioiTinh = ds[i].gioiTinh;
//			sv.ma = ds[i].ma;
//			sv.diem.toan = ds[i].diem.toan;
//			sv.diem.van = ds[i].diem.van;
//			sv.diem.anh = ds[i].diem.anh;
//			sv.diem.tbc = ds[i].diem.tbc;
			timSV = 1;
